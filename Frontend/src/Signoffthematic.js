...
function Signoffthematic() {
    ...
    function signoffData() {
        if (!enablesignoff && rowdata.length > 0) {
            let urls={
                "thematichead" :'https://service.rbmgateway.org/thematicsignoff',
                "cpapthematic" : 'https://service.rbmgateway.org/thematicheadSignOffcpap',
                "rrfthematic" : 'https://service.rbmgateway.org/thematicheadSignOffrrf'
            }
