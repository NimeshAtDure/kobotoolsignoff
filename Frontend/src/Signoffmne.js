...
function Signoffmne() {
    ...
    function editRowData() {
        ...
        axios({
            ...
            data: {
                ...
                "type": ["cpapmne","rrfmne"].includes(value)?value:"mnehead",
    ...
    function signoffData() {
        if (!enablesignoff) {
            let urls= {
                "mneheadoi":'https://service.rbmgateway.org/m&esignoffoi',
                "mneheadsis":'https://service.rbmgateway.org/m&esignoff',
                "mneheadnr":'https://service.rbmgateway.org/m&esignoff',
                "cpapmne":'https://service.rbmgateway.org/mneSignOffcpap',
                "rrfmne":'https://service.rbmgateway.org/mneSignOffrrf'
            }
            ...
            <div className="App signoffpg progressoverviewpage signoff-section mnesignoff">
                ...
                <Paper sx={{ width: '100%', overflow: 'hidden' }} >
                    ...
                    >
                        ...
                        <Tab value="cpapmne" label="CPAP" />
                        <Tab value="rrfmne" label="RRF" />
